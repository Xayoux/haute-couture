...
L'estimation de cette régression par la méthode des moindres carrés ordinaire permet d'obtenir les résidus $\epsilon_{ijkt}$. La compétitivité hors-prix en niveau est obtenue en prenant l'exponentielle du résidus normalisé par l'élasticité du commerce international.
