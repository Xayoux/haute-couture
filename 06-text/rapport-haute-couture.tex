...
% La mode et la Haute Couture renvoient à deux notions différentes \cite{Agogue2010}. La Haute Couture renvoit à une notion de luxe caractérisé par une forte valeur de l'image du produit et une faible valeur de fonctionnalité relativement à son prix. Ces produits permettent de marquer le statut des personnes les achetant et mettent l'accent sur une différenciation verticale avec les produits \og standards\fg{}. Les produits de la mode opèrent plutôt sur une différenciation horizontale. Ces produits permettent d'afficher la singularité d'un individu ou son appartenance à un groupe. Il s'agit d'une technique de différenciation éphémère.
