...
% Balance commerciale
% indiquer en nbp que les importations sont déifnies par rapportrs aux flux d'exportation HG : pas de nouvelle procédure pour sélectionner les flux d'importation. 
...
\begin{figure}[!hb] % Utilise [H] pour forcer le placement ici
    \centering
...
\captionsetup{justification=centering, singlelinecheck=true, font=normalsize}
\caption{Codes du Système Harmonisé dans les révisions de 1992 et 2022 et leur description de 2022 associées}\\
\hline
